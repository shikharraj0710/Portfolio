...
export default function ContactForm({ hireRef }) {
  ...
  return (
    <>
    <div ref={ref}>
      <motion.div animate={animation} ref={hireRef} className="border-4  rounded-4 border-darkGolden  rounded w-[95%] lg:w-[80%] mx-auto py-8 px-6 flex flex-col md:flex-row items-start md:items-center md:mb-20 mb-10">
