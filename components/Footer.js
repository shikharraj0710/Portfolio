...
export default function Footer() {
	return (
			...
			<Link href="/"><a><Image src='/../public/images/logo.png' width={40} height={45} /></a></Link>
				<p className="text-sm sm:ml-4 text-darkGrey sm:pl-4 sm:border-l-2 sm:border-darkGrey sm:py-2 sm:mt-0 mt-4">
					© 2022 Copyright -----
				...
				<Link href="https://github.com/shikharraj0710">
					<a className="ml-[10px] text-darkGolden hover:scale-150" target="_blank">
					<i class="fab fa-github"></i>
					</a>
					</Link>
					<Link href="https://www.facebook.com/shikharraj.mishra.7/">
					<a className="text-darkGolden hover:scale-150" target="_blank">
					...
					<a className="ml-3 text-darkGolden hover:scale-150" target="_blank">
						<svg fill="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="2" className="w-5 h-5" viewBox="0 0 24 24">
