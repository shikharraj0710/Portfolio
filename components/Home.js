        ...
        <motion.div animate={animation2} className="lg:flex-grow md:w-1/2 lg:pl-24  flex flex-col md:items-start  items-center w-[80%]">
          ...
          <div className="flex justify-between items-center w-full">
            <button
              ...
              className="px-4 text-sm uppercase font-sans border-2 border-darkGolden rounded-md p-2 hover:bg-orange-400 hover:text-white transition ease-in-out delay-50  hover:-translate-y-1 hover:scale-110 tracking-widest animate-bounce"
            >
              hire me
            </button>
